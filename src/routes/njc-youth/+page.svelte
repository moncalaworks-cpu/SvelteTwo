...
<svelte:head>
  <title>NJC Youth - {church.name}</title>
</svelte:head>
...
<section class="relative w-full h-80 bg-gradient-to-r from-purple-900 to-purple-800 dark:from-gray-950 dark:to-gray-900 flex items-center justify-center">
  ...
  <div class="relative z-10 text-center">
    <h1 class="text-4xl md:text-5xl font-bold text-white !text-white">{t('njcYouth.title')}</h1>
  </div>
</section>
    ...
    <section>
      ...
      <div class="bg-gray-200 dark:bg-gray-800 rounded-lg p-6">
        ...
        <a
          ...
          class="inline-block bg-purple-400 hover:bg-purple-500 text-black font-bold py-2 px-4 rounded-lg transition-colors text-sm"
        >
          {t('njcYouth.visitButton')}
        </a>
      </div>
    </section>
  </div>
